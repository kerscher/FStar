...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___43_5369 =
          match uu___43_5369 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___45_5499  ->
    match uu___45_5499 with | Hash  -> "#" | uu____5500 -> ""
