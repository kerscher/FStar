open Prims
let (uu___121 : Prims.unit) = FStar_Version.dummy () 
let (process_args :
  Prims.unit ->
                  ...
                  then
                    ...
                    (let uu____429 = FStar_Options.interactive ()  in
                     ...
                     then
                       ...
                       (let uu____441 = FStar_Options.doc ()  in
                        if uu____441
                        then FStar_Fsdoc_Generator.generate filenames
                        else
                          (let uu____443 = FStar_Options.indent ()  in
                           if uu____443
                           then
  ...
  fun k  ->
    fun i  ->
      ...
      | FStar_Syntax_Syntax.Lazy_binder  ->
          FStar_Reflection_Basic.unfold_lazy_binder i
      | FStar_Syntax_Syntax.Lazy_fvar  ->
          FStar_Reflection_Basic.unfold_lazy_fvar i
      | FStar_Syntax_Syntax.Lazy_comp  ->
          FStar_Reflection_Basic.unfold_lazy_comp i
      | FStar_Syntax_Syntax.Lazy_env  ->
          FStar_Reflection_Basic.unfold_lazy_env i
      | FStar_Syntax_Syntax.Lazy_proofstate  ->
          FStar_Tactics_Embedding.unfold_lazy_proofstate i
  
let main : 'Auu____617 . Prims.unit -> 'Auu____617 =
  fun uu____621  ->
    try
